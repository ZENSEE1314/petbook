...
function GuideEditor({
  ...
  const fields: Array<[keyof GuideEntry, string]> = [
    ...
    ["lifespan_years", "Lifespan — general (fallback)"],
    ["lifespan_wild", "🌿 Lifespan in the wild"],
    ["lifespan_pet", "🏠 Lifespan as a home pet"],
    ...
    ["foods_to_avoid", "Foods / substances to avoid (toxic, harmful)"],
    ["sickness_signs", "Warning signs of illness (early indicators)"],
    ["sexing", "How to tell male vs female"],
    ["weight_range_male", "♂ Male weight range"],
    ["weight_range_female", "♀ Female weight range"],
    ["length_range_male", "♂ Male length / height"],
    ["length_range_female", "♀ Female length / height"],
    ["colors_male", "♂ Male colour variations"],
    ["colors_female", "♀ Female colour variations"],
    ["diet_male", "♂ Male diet specifics"],
    ["diet_female", "♀ Female diet specifics"],
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {fields.map(([key, label]) => {
              const isLong = [
                ...
                "colors_male", "colors_female", "diet_male", "diet_female",
